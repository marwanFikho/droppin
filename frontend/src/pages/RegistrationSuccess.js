        ...
        <div className="success-message">
          ...
          {userType === 'shop' && (
            <div className="approval-info">
              <h3>{t('registration.success.whatNext')}</h3>
              <ol>
          ...
          <div className="action-buttons">
            <Link to="/login" className="auth-button">{t('registration.success.goToLogin')}</Link>
            <Link to="/" className="auth-button secondary">{t('registration.success.backToHome')}</Link>
          </div>
        </div>
      </div>
    </div>
