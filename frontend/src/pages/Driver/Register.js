    ...
    <div className="driver-register">
      <div className="driver-register-container">
        <div className="driver-register-header">
          <div className="driver-register-icon">🚚</div>
          <h1 className="driver-register-title">{t('driver.register.joinAsDriver')}</h1>
          <p className="driver-register-subtitle">{t('driver.register.startEarning')}</p>
        </div>
        ...
        <div className="driver-register-footer">
          <p className="driver-register-footer-text">
            {t('driver.register.alreadyHaveAccount')} 
            <Link to="/login" className="driver-register-link">
