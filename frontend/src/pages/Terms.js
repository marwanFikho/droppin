      ...
      >
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="h4 fw-700 mb-3" style={{ color: '#235789' }}>{t('legal.contactInfo.title')}</h2>
            <p style={{ color: '#4b5563' }}>{t('legal.contactInfo.subtitle')}</p>
            <ul className="list-unstyled mb-0" style={{ color: '#4b5563', lineHeight: '1.8' }}>
