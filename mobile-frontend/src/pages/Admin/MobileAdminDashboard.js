          ...
          <div className="mobile-modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="mobile-modal-body">
              <div className="mobile-modal-details-grid">
                ...
                <div className="mobile-modal-detail-item"><span className="label">Amount Paid</span><span>EGP {parseFloat(selectedPackage.paidAmount || 0).toFixed(2)}</span></div>
          ...
          <div className="mobile-modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="mobile-modal-body">
              <div className="mobile-modal-details-grid">
                ...
                <div className="mobile-modal-detail-item"><span className="label">Amount Paid</span><span>EGP {parseFloat(selectedAdminPackage.paidAmount || 0).toFixed(2)}</span></div>
                <div className="mobile-modal-detail-item"><span className="label">Delivery Cost</span>
                {editingDeliveryCost ? (
                  <span style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <input
